...
The classic off-the-shelf abstract interpretation, and for which there are open-source implementations widely available (e.g. [BAP](https://github.com/BinaryAnalysisPlatform/bap)), is Value Set Analysis (VSA). Eventually `jove` will probably acquire an implementation of VSA.

...
### How is `jove` tested?
The application and its recompiled counterpart are run on the same inputs. The standard output, standard error, and exit codes must be identical for both runs.

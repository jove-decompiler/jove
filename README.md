...
To recover the full C code of the program from its compiled representation, we'll run its recompiled form over-and-over again with a (suitable) command-line input.

...
The CI test suite spins up whole-system (i.e. using `qemu-system-*`) debian emulations, so we can test jove easily on different architectures without possessing a physical machine.

...
mipsel-float_cvtd_s_EXTRICATE_ARGS := float32_to_float64
mipsel-float_cvtd_w_EXTRICATE_ARGS := int32_to_float64
mipsel-float_cvtd_l_EXTRICATE_ARGS := int64_to_float64
mipsel-float_cvtps_pw_EXTRICATE_ARGS := int32_to_float32
mipsel-float_cvtpw_ps_EXTRICATE_ARGS := float32_to_int32
mipsel-float_cvts_d_EXTRICATE_ARGS := float64_to_float32
mipsel-float_cvts_w_EXTRICATE_ARGS := int32_to_float32
mipsel-float_cvts_l_EXTRICATE_ARGS := int64_to_float32
mipsel-float_addr_ps_EXTRICATE_ARGS := float32_add
mipsel-float_mulr_ps_EXTRICATE_ARGS := float32_mul
mipsel-float_class_s_EXTRICATE_ARGS := float32_is_quiet_nan float32_is_signaling_nan
mipsel-float_class_d_EXTRICATE_ARGS := float64_is_quiet_nan float64_is_signaling_nan
mipsel-float_maddf_s_EXTRICATE_ARGS := float32_muladd
mipsel-float_maddf_d_EXTRICATE_ARGS := float64_muladd
mipsel-float_msubf_s_EXTRICATE_ARGS := float32_muladd
mipsel-float_msubf_d_EXTRICATE_ARGS := float64_muladd
mipsel-float_max_s_EXTRICATE_ARGS := float32_maxnum
mipsel-float_max_d_EXTRICATE_ARGS := float64_maxnum
mipsel-float_maxa_s_EXTRICATE_ARGS := float32_maxnummag
mipsel-float_maxa_d_EXTRICATE_ARGS := float64_maxnummag
mipsel-float_min_s_EXTRICATE_ARGS := float32_minnum
mipsel-float_min_d_EXTRICATE_ARGS := float64_minnum
mipsel-float_mina_s_EXTRICATE_ARGS := float32_minnummag
mipsel-float_mina_d_EXTRICATE_ARGS := float64_minnummag
mipsel-float_cvt_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_cvt_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_cvt_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_cvt_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_round_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_round_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_round_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_round_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_trunc_l_s_EXTRICATE_ARGS := float32_to_int64_round_to_zero
mipsel-float_trunc_l_d_EXTRICATE_ARGS := float64_to_int64_round_to_zero
mipsel-float_trunc_w_s_EXTRICATE_ARGS := float32_to_int32_round_to_zero
mipsel-float_trunc_w_d_EXTRICATE_ARGS := float64_to_int32_round_to_zero
mipsel-float_ceil_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_ceil_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_ceil_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_ceil_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_floor_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_floor_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_floor_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_floor_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_cvt_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_cvt_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_cvt_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_cvt_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_round_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_round_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_round_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_round_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_trunc_2008_l_s_EXTRICATE_ARGS := float32_to_int64_round_to_zero
mipsel-float_trunc_2008_l_d_EXTRICATE_ARGS := float64_to_int64_round_to_zero
mipsel-float_trunc_2008_w_s_EXTRICATE_ARGS := float32_to_int32_round_to_zero
mipsel-float_trunc_2008_w_d_EXTRICATE_ARGS := float64_to_int32_round_to_zero
mipsel-float_ceil_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_ceil_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_ceil_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_ceil_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_floor_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mipsel-float_floor_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mipsel-float_floor_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mipsel-float_floor_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mipsel-float_sqrt_s_EXTRICATE_ARGS := float32_sqrt
mipsel-float_sqrt_d_EXTRICATE_ARGS := float64_sqrt
mipsel-float_rsqrt_s_EXTRICATE_ARGS := float32_div float32_sqrt
mipsel-float_rsqrt_d_EXTRICATE_ARGS := float64_div float64_sqrt
mipsel-float_recip_s_EXTRICATE_ARGS := float32_div
mipsel-float_recip_d_EXTRICATE_ARGS := float64_div
mipsel-float_rint_s_EXTRICATE_ARGS := float32_round_to_int
mipsel-float_rint_d_EXTRICATE_ARGS := float64_round_to_int
mipsel-float_recip1_s_EXTRICATE_ARGS := float32_div
mipsel-float_recip1_d_EXTRICATE_ARGS := float64_div
mipsel-float_recip1_ps_EXTRICATE_ARGS := float32_div
mipsel-float_rsqrt1_s_EXTRICATE_ARGS := float32_div float32_sqrt
mipsel-float_rsqrt1_d_EXTRICATE_ARGS := float64_div float64_sqrt
mipsel-float_rsqrt1_ps_EXTRICATE_ARGS := float32_div float32_sqrt
mipsel-float_add_s_EXTRICATE_ARGS := float32_add float64_add
mipsel-float_add_d_EXTRICATE_ARGS := float32_add float64_add
mipsel-float_add_ps_EXTRICATE_ARGS := float32_add float64_add
mipsel-float_sub_s_EXTRICATE_ARGS := float32_sub float64_sub
mipsel-float_sub_d_EXTRICATE_ARGS := float32_sub float64_sub
mipsel-float_sub_ps_EXTRICATE_ARGS := float32_sub float64_sub
mipsel-float_mul_s_EXTRICATE_ARGS := float32_mul float64_mul
mipsel-float_mul_d_EXTRICATE_ARGS := float32_mul float64_mul
mipsel-float_mul_ps_EXTRICATE_ARGS := float32_mul float64_mul
mipsel-float_div_s_EXTRICATE_ARGS := float32_div float64_div
mipsel-float_div_d_EXTRICATE_ARGS := float32_div float64_div
mipsel-float_div_ps_EXTRICATE_ARGS := float32_div float64_div
mipsel-float_recip2_s_EXTRICATE_ARGS := float32_sub float32_mul
mipsel-float_recip2_d_EXTRICATE_ARGS := float64_sub float64_mul
mipsel-float_recip2_ps_EXTRICATE_ARGS := float32_sub float32_mul
mipsel-float_rsqrt2_s_EXTRICATE_ARGS := float32_div float32_sub float32_mul
mipsel-float_rsqrt2_d_EXTRICATE_ARGS := float64_div float64_sub float64_mul
mipsel-float_rsqrt2_ps_EXTRICATE_ARGS := float32_div float32_sub float32_mul
mipsel-float_madd_s_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_madd_d_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_madd_ps_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_msub_s_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-float_msub_d_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-float_msub_ps_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-float_nmadd_s_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_nmadd_d_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_nmadd_ps_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mipsel-float_nmsub_s_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-float_nmsub_d_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-float_nmsub_ps_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mipsel-cmp_d_f_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-cmpabs_d_f_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-cmp_s_f_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmpabs_s_f_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmp_ps_f_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmpabs_ps_f_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmp_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-cmpabs_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-cmp_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmpabs_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmp_ps_un_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmpabs_ps_un_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-cmp_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mipsel-cmpabs_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mipsel-cmp_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mipsel-cmpabs_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mipsel-cmp_ps_eq_EXTRICATE_ARGS := float32_eq_quiet
mipsel-cmpabs_ps_eq_EXTRICATE_ARGS := float32_eq_quiet
mipsel-cmp_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mipsel-cmpabs_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mipsel-cmp_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mipsel-cmpabs_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mipsel-cmp_ps_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mipsel-cmpabs_ps_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mipsel-cmp_d_olt_EXTRICATE_ARGS := float64_lt_quiet
mipsel-cmpabs_d_olt_EXTRICATE_ARGS := float64_lt_quiet
mipsel-cmp_s_olt_EXTRICATE_ARGS := float32_lt_quiet
mipsel-cmpabs_s_olt_EXTRICATE_ARGS := float32_lt_quiet
mipsel-cmp_ps_olt_EXTRICATE_ARGS := float32_lt_quiet
mipsel-cmpabs_ps_olt_EXTRICATE_ARGS := float32_lt_quiet
mipsel-cmp_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mipsel-cmpabs_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mipsel-cmp_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-cmpabs_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-cmp_ps_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-cmpabs_ps_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-cmp_d_ole_EXTRICATE_ARGS := float64_le_quiet
mipsel-cmpabs_d_ole_EXTRICATE_ARGS := float64_le_quiet
mipsel-cmp_s_ole_EXTRICATE_ARGS := float32_le_quiet
mipsel-cmpabs_s_ole_EXTRICATE_ARGS := float32_le_quiet
mipsel-cmp_ps_ole_EXTRICATE_ARGS := float32_le_quiet
mipsel-cmpabs_ps_ole_EXTRICATE_ARGS := float32_le_quiet
mipsel-cmp_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mipsel-cmpabs_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mipsel-cmp_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mipsel-cmpabs_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mipsel-cmp_ps_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mipsel-cmpabs_ps_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mipsel-cmp_d_sf_EXTRICATE_ARGS := float64_unordered
mipsel-cmpabs_d_sf_EXTRICATE_ARGS := float64_unordered
mipsel-cmp_s_sf_EXTRICATE_ARGS := float32_unordered
mipsel-cmpabs_s_sf_EXTRICATE_ARGS := float32_unordered
mipsel-cmp_ps_sf_EXTRICATE_ARGS := float32_unordered
mipsel-cmpabs_ps_sf_EXTRICATE_ARGS := float32_unordered
mipsel-cmp_d_ngle_EXTRICATE_ARGS := float64_unordered
mipsel-cmpabs_d_ngle_EXTRICATE_ARGS := float64_unordered
mipsel-cmp_s_ngle_EXTRICATE_ARGS := float32_unordered
mipsel-cmpabs_s_ngle_EXTRICATE_ARGS := float32_unordered
mipsel-cmp_ps_ngle_EXTRICATE_ARGS := float32_unordered
mipsel-cmpabs_ps_ngle_EXTRICATE_ARGS := float32_unordered
mipsel-cmp_d_seq_EXTRICATE_ARGS := float64_eq
mipsel-cmpabs_d_seq_EXTRICATE_ARGS := float64_eq
mipsel-cmp_s_seq_EXTRICATE_ARGS := float32_eq
mipsel-cmpabs_s_seq_EXTRICATE_ARGS := float32_eq
mipsel-cmp_ps_seq_EXTRICATE_ARGS := float32_eq
mipsel-cmpabs_ps_seq_EXTRICATE_ARGS := float32_eq
mipsel-cmp_d_ngl_EXTRICATE_ARGS := float64_eq float64_unordered
mipsel-cmpabs_d_ngl_EXTRICATE_ARGS := float64_eq float64_unordered
mipsel-cmp_s_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mipsel-cmpabs_s_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mipsel-cmp_ps_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mipsel-cmpabs_ps_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mipsel-cmp_d_lt_EXTRICATE_ARGS := float64_lt
mipsel-cmpabs_d_lt_EXTRICATE_ARGS := float64_lt
mipsel-cmp_s_lt_EXTRICATE_ARGS := float32_lt
mipsel-cmpabs_s_lt_EXTRICATE_ARGS := float32_lt
mipsel-cmp_ps_lt_EXTRICATE_ARGS := float32_lt
mipsel-cmpabs_ps_lt_EXTRICATE_ARGS := float32_lt
mipsel-cmp_d_nge_EXTRICATE_ARGS := float64_lt float64_unordered
mipsel-cmpabs_d_nge_EXTRICATE_ARGS := float64_lt float64_unordered
mipsel-cmp_s_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-cmpabs_s_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-cmp_ps_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-cmpabs_ps_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-cmp_d_le_EXTRICATE_ARGS := float64_le
mipsel-cmpabs_d_le_EXTRICATE_ARGS := float64_le
mipsel-cmp_s_le_EXTRICATE_ARGS := float32_le
mipsel-cmpabs_s_le_EXTRICATE_ARGS := float32_le
mipsel-cmp_ps_le_EXTRICATE_ARGS := float32_le
mipsel-cmpabs_ps_le_EXTRICATE_ARGS := float32_le
mipsel-cmp_d_ngt_EXTRICATE_ARGS := float64_le float64_unordered
mipsel-cmpabs_d_ngt_EXTRICATE_ARGS := float64_le float64_unordered
mipsel-cmp_s_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mipsel-cmpabs_s_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mipsel-cmp_ps_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mipsel-cmpabs_ps_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mipsel-r6_cmp_d_af_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-r6_cmp_s_af_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-r6_cmp_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mipsel-r6_cmp_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mipsel-r6_cmp_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mipsel-r6_cmp_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mipsel-r6_cmp_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mipsel-r6_cmp_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mipsel-r6_cmp_d_lt_EXTRICATE_ARGS := float64_lt_quiet
mipsel-r6_cmp_s_lt_EXTRICATE_ARGS := float32_lt_quiet
mipsel-r6_cmp_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mipsel-r6_cmp_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-r6_cmp_d_le_EXTRICATE_ARGS := float64_le_quiet
mipsel-r6_cmp_s_le_EXTRICATE_ARGS := float32_le_quiet
mipsel-r6_cmp_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mipsel-r6_cmp_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mipsel-r6_cmp_d_saf_EXTRICATE_ARGS := float64_unordered
mipsel-r6_cmp_s_saf_EXTRICATE_ARGS := float32_unordered
mipsel-r6_cmp_d_sun_EXTRICATE_ARGS := float64_unordered
mipsel-r6_cmp_s_sun_EXTRICATE_ARGS := float32_unordered
mipsel-r6_cmp_d_seq_EXTRICATE_ARGS := float64_eq
mipsel-r6_cmp_s_seq_EXTRICATE_ARGS := float32_eq
mipsel-r6_cmp_d_sueq_EXTRICATE_ARGS := float64_eq float64_unordered
mipsel-r6_cmp_s_sueq_EXTRICATE_ARGS := float32_eq float32_unordered
mipsel-r6_cmp_d_slt_EXTRICATE_ARGS := float64_lt
mipsel-r6_cmp_s_slt_EXTRICATE_ARGS := float32_lt
mipsel-r6_cmp_d_sult_EXTRICATE_ARGS := float64_lt float64_unordered
mipsel-r6_cmp_s_sult_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-r6_cmp_d_sle_EXTRICATE_ARGS := float64_le
mipsel-r6_cmp_s_sle_EXTRICATE_ARGS := float32_le
mipsel-r6_cmp_d_sule_EXTRICATE_ARGS := float64_le float64_unordered
mipsel-r6_cmp_s_sule_EXTRICATE_ARGS := float32_le float32_unordered
mipsel-r6_cmp_d_or_EXTRICATE_ARGS := float64_le_quiet
mipsel-r6_cmp_s_or_EXTRICATE_ARGS := float32_le_quiet
mipsel-r6_cmp_d_une_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mipsel-r6_cmp_s_une_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mipsel-r6_cmp_d_ne_EXTRICATE_ARGS := float64_lt_quiet
mipsel-r6_cmp_s_ne_EXTRICATE_ARGS := float32_lt_quiet
mipsel-r6_cmp_d_sor_EXTRICATE_ARGS := float64_le
mipsel-r6_cmp_s_sor_EXTRICATE_ARGS := float32_le
mipsel-r6_cmp_d_sune_EXTRICATE_ARGS := float64_lt float64_unordered
mipsel-r6_cmp_s_sune_EXTRICATE_ARGS := float32_lt float32_unordered
mipsel-r6_cmp_d_sne_EXTRICATE_ARGS := float64_lt
mipsel-r6_cmp_s_sne_EXTRICATE_ARGS := float32_lt
mipsel-msa_ctcmsa_EXTRICATE_ARGS := ieee_rm
mipsel-msa_fcaf_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_default_nan float32_default_nan float32_eq_quiet
mipsel-msa_fcun_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mipsel-msa_fceq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_default_nan float32_default_nan float32_eq_quiet
mipsel-msa_fcueq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_unordered_quiet float32_eq_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mipsel-msa_fclt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_default_nan float32_default_nan float32_lt_quiet
mipsel-msa_fcult_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_unordered_quiet float64_default_nan float32_lt_quiet float32_default_nan float32_unordered_quiet
mipsel-msa_fcle_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_le_quiet float32_le_quiet
mipsel-msa_fcule_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered_quiet float64_le_quiet float32_le_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mipsel-msa_fsaf_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float64_eq float32_default_nan float32_eq
mipsel-msa_fsun_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered float64_default_nan float32_default_nan float32_unordered
mipsel-msa_fseq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float64_eq float32_default_nan float32_eq
mipsel-msa_fsueq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered float32_eq float64_eq float64_default_nan float32_default_nan float32_unordered
mipsel-msa_fslt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_default_nan float32_default_nan float32_lt
mipsel-msa_fsult_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_unordered float32_lt float64_default_nan float32_default_nan float32_unordered
mipsel-msa_fsle_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_default_nan float32_default_nan float32_le
mipsel-msa_fsule_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_unordered float32_le float64_default_nan float32_default_nan float32_unordered
mipsel-msa_fadd_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_add float32_add
mipsel-msa_fsub_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_sub float64_default_nan float32_default_nan float32_sub
mipsel-msa_fmul_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_mul float64_default_nan float32_default_nan float32_mul
mipsel-msa_fdiv_df_EXTRICATE_ARGS := float64_div float64_default_nan float32_default_nan ieee_ex_to_mips float32_div
mipsel-msa_fmadd_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_muladd float64_default_nan float32_default_nan float32_muladd
mipsel-msa_fmsub_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_muladd float64_default_nan float32_default_nan float32_muladd
mipsel-msa_fexp2_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_scalbn float64_default_nan float32_default_nan float32_scalbn
mipsel-msa_fexdo_df_EXTRICATE_ARGS := float64_to_float32 float32_to_float16 float32_default_nan ieee_ex_to_mips float16_default_nan
mipsel-msa_ftq_df_EXTRICATE_ARGS := float64_to_int64 float64_scalbn float32_to_int32 float32_scalbn float_raise float32_default_nan ieee_ex_to_mips float16_default_nan
mipsel-msa_fmin_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_min float64_is_quiet_nan float64_default_nan float32_default_nan float32_min float32_is_quiet_nan
mipsel-msa_fmin_a_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_max float64_min float64_is_quiet_nan float32_max float64_default_nan float32_default_nan float32_min float32_is_quiet_nan
mipsel-msa_fmax_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_max float64_is_quiet_nan float64_default_nan float32_default_nan float32_max float32_is_quiet_nan
mipsel-msa_fmax_a_df_EXTRICATE_ARGS := float64_min ieee_ex_to_mips float64_max float64_is_quiet_nan float64_default_nan float32_default_nan float32_max float32_min float32_is_quiet_nan
mipsel-msa_fcor_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_le_quiet float32_le_quiet
mipsel-msa_fcune_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_unordered_quiet float64_default_nan float32_lt_quiet float32_default_nan float32_unordered_quiet
mipsel-msa_fcne_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_default_nan float32_default_nan float32_lt_quiet
mipsel-msa_fsor_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_default_nan float32_default_nan float32_le
mipsel-msa_fsune_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_unordered float32_lt float64_default_nan float32_default_nan float32_unordered
mipsel-msa_fsne_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_default_nan float32_default_nan float32_lt
mipsel-msa_fclass_df_EXTRICATE_ARGS := float_class_d float_class_s
mipsel-msa_ftrunc_s_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_int64_round_to_zero float64_default_nan float32_default_nan float32_to_int32_round_to_zero
mipsel-msa_ftrunc_u_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_to_uint64_round_to_zero float32_to_uint32_round_to_zero
mipsel-msa_fsqrt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_sqrt float32_sqrt
mipsel-msa_frsqrt_df_EXTRICATE_ARGS := float64_is_quiet_nan float64_div float64_default_nan float32_default_nan float32_is_quiet_nan float64_sqrt float32_sqrt ieee_ex_to_mips float32_div
mipsel-msa_frcp_df_EXTRICATE_ARGS := float64_is_quiet_nan float64_div float64_default_nan float32_default_nan float32_is_quiet_nan ieee_ex_to_mips float32_div
mipsel-msa_frint_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_round_to_int float64_default_nan float32_default_nan float32_round_to_int
mipsel-msa_flog2_df_EXTRICATE_ARGS := ieee_rm ieee_ex_to_mips float64_round_to_int float64_default_nan float32_default_nan float32_round_to_int float64_log2 float32_log2
mipsel-msa_fexupl_df_EXTRICATE_ARGS := float32_to_float64 ieee_ex_to_mips float16_to_float32 float64_default_nan float32_default_nan
mipsel-msa_fexupr_df_EXTRICATE_ARGS := float32_to_float64 ieee_ex_to_mips float16_to_float32 float64_default_nan float32_default_nan
mipsel-msa_ffql_df_EXTRICATE_ARGS := float64_scalbn int32_to_float64 ieee_ex_to_mips float32_scalbn int32_to_float32 float64_default_nan float32_default_nan
mipsel-msa_ffqr_df_EXTRICATE_ARGS := float64_scalbn int32_to_float64 ieee_ex_to_mips float32_scalbn int32_to_float32 float64_default_nan float32_default_nan
mipsel-msa_ftint_s_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_int64 float64_default_nan float32_default_nan float32_to_int32
mipsel-msa_ftint_u_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_uint64 float64_default_nan float32_default_nan float32_to_uint32
mipsel-msa_ffint_s_df_EXTRICATE_ARGS := ieee_ex_to_mips int64_to_float64 float64_default_nan float32_default_nan int32_to_float32
mipsel-msa_ffint_u_df_EXTRICATE_ARGS := ieee_ex_to_mips uint64_to_float64 float64_default_nan float32_default_nan uint32_to_float32

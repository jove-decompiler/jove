...
TOOLBINS   := $(foreach target,$(ALL_TARGETS),$(foreach tool,$(TOOLS),$(BINDIR)/$(target)/$(tool)))
TOOLDEPS   := $(foreach target,$(ALL_TARGETS),$(foreach tool,$(TOOLS),$(BINDIR)/$(target)/$(tool).d))
...
$(BINDIR)/$(2)/$(1): $(TOOLSRCDIR)/$(1).cpp
	@echo CXX $(1) "[$(2)]"
	$(_LLVM_CXX) -o $$@ -pipe -MMD $(CXXFLAGS) $$< $(LDFLAGS) -I lib/arch/$(2) -D TARGET_$(call uc,$(2)) $($(2)_ARCH_CFLAGS) -D TARGET_ARCH_NAME=\"$($(2)_ARCH_NAME)\" -fPIC -static
endef
...
$(BINDIR)/$(1)/jove.bc: lib/arch/$(1)/jove.c
	@echo CC $$<
	$(_LLVM_CC) -o $$@ -c -MMD -emit-llvm -I lib -I include -I third_party/boost-preprocessor/include -D TARGET_$(call uc,$(1)) --target=$($(1)_TRIPLE) -Ofast --sysroot $($(1)_sysroot) -ffreestanding -fno-stack-protector -D TARGET_ARCH_NAME=\"$($(1)_ARCH_NAME)\" -std=gnu99 -fPIC -g -Wall $$<

$(BINDIR)/$(1)/jove.dfsan.bc: lib/arch/$(1)/jove.c
	@echo CC "(DFSAN)" $$<
	$(_LLVM_CC) -o $$@ -c -MMD -emit-llvm -I lib -I include -I third_party/boost-preprocessor/include -D TARGET_$(call uc,$(1)) --target=$($(1)_TRIPLE) -Ofast --sysroot $($(1)_sysroot) -ffreestanding -fno-stack-protector -D TARGET_ARCH_NAME=\"$($(1)_ARCH_NAME)\" -std=gnu99 -fPIC -g -Wall -DJOVE_DFSAN $$<
endef
...
mips32-float_cvtd_s_EXTRICATE_ARGS := float32_to_float64
mips32-float_cvtd_w_EXTRICATE_ARGS := int32_to_float64
mips32-float_cvtd_l_EXTRICATE_ARGS := int64_to_float64
mips32-float_cvtps_pw_EXTRICATE_ARGS := int32_to_float32
mips32-float_cvtpw_ps_EXTRICATE_ARGS := float32_to_int32
mips32-float_cvts_d_EXTRICATE_ARGS := float64_to_float32
mips32-float_cvts_w_EXTRICATE_ARGS := int32_to_float32
mips32-float_cvts_l_EXTRICATE_ARGS := int64_to_float32
mips32-float_addr_ps_EXTRICATE_ARGS := float32_add
mips32-float_mulr_ps_EXTRICATE_ARGS := float32_mul
mips32-float_class_s_EXTRICATE_ARGS := float32_is_quiet_nan float32_is_signaling_nan
mips32-float_class_d_EXTRICATE_ARGS := float64_is_quiet_nan float64_is_signaling_nan
mips32-float_maddf_s_EXTRICATE_ARGS := float32_muladd
mips32-float_maddf_d_EXTRICATE_ARGS := float64_muladd
mips32-float_msubf_s_EXTRICATE_ARGS := float32_muladd
mips32-float_msubf_d_EXTRICATE_ARGS := float64_muladd
mips32-float_max_s_EXTRICATE_ARGS := float32_maxnum
mips32-float_max_d_EXTRICATE_ARGS := float64_maxnum
mips32-float_maxa_s_EXTRICATE_ARGS := float32_maxnummag
mips32-float_maxa_d_EXTRICATE_ARGS := float64_maxnummag
mips32-float_min_s_EXTRICATE_ARGS := float32_minnum
mips32-float_min_d_EXTRICATE_ARGS := float64_minnum
mips32-float_mina_s_EXTRICATE_ARGS := float32_minnummag
mips32-float_mina_d_EXTRICATE_ARGS := float64_minnummag
mips32-float_cvt_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_cvt_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_cvt_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_cvt_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_round_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_round_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_round_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_round_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_trunc_l_s_EXTRICATE_ARGS := float32_to_int64_round_to_zero
mips32-float_trunc_l_d_EXTRICATE_ARGS := float64_to_int64_round_to_zero
mips32-float_trunc_w_s_EXTRICATE_ARGS := float32_to_int32_round_to_zero
mips32-float_trunc_w_d_EXTRICATE_ARGS := float64_to_int32_round_to_zero
mips32-float_ceil_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_ceil_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_ceil_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_ceil_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_floor_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_floor_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_floor_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_floor_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_cvt_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_cvt_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_cvt_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_cvt_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_round_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_round_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_round_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_round_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_trunc_2008_l_s_EXTRICATE_ARGS := float32_to_int64_round_to_zero
mips32-float_trunc_2008_l_d_EXTRICATE_ARGS := float64_to_int64_round_to_zero
mips32-float_trunc_2008_w_s_EXTRICATE_ARGS := float32_to_int32_round_to_zero
mips32-float_trunc_2008_w_d_EXTRICATE_ARGS := float64_to_int32_round_to_zero
mips32-float_ceil_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_ceil_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_ceil_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_ceil_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_floor_2008_l_s_EXTRICATE_ARGS := float32_to_int64
mips32-float_floor_2008_l_d_EXTRICATE_ARGS := float64_to_int64
mips32-float_floor_2008_w_s_EXTRICATE_ARGS := float32_to_int32
mips32-float_floor_2008_w_d_EXTRICATE_ARGS := float64_to_int32
mips32-float_sqrt_s_EXTRICATE_ARGS := float32_sqrt
mips32-float_sqrt_d_EXTRICATE_ARGS := float64_sqrt
mips32-float_rsqrt_s_EXTRICATE_ARGS := float32_div float32_sqrt
mips32-float_rsqrt_d_EXTRICATE_ARGS := float64_div float64_sqrt
mips32-float_recip_s_EXTRICATE_ARGS := float32_div
mips32-float_recip_d_EXTRICATE_ARGS := float64_div
mips32-float_rint_s_EXTRICATE_ARGS := float32_round_to_int
mips32-float_rint_d_EXTRICATE_ARGS := float64_round_to_int
mips32-float_recip1_s_EXTRICATE_ARGS := float32_div
mips32-float_recip1_d_EXTRICATE_ARGS := float64_div
mips32-float_recip1_ps_EXTRICATE_ARGS := float32_div
mips32-float_rsqrt1_s_EXTRICATE_ARGS := float32_div float32_sqrt
mips32-float_rsqrt1_d_EXTRICATE_ARGS := float64_div float64_sqrt
mips32-float_rsqrt1_ps_EXTRICATE_ARGS := float32_div float32_sqrt
mips32-float_add_s_EXTRICATE_ARGS := float32_add float64_add
mips32-float_add_d_EXTRICATE_ARGS := float32_add float64_add
mips32-float_add_ps_EXTRICATE_ARGS := float32_add float64_add
mips32-float_sub_s_EXTRICATE_ARGS := float32_sub float64_sub
mips32-float_sub_d_EXTRICATE_ARGS := float32_sub float64_sub
mips32-float_sub_ps_EXTRICATE_ARGS := float32_sub float64_sub
mips32-float_mul_s_EXTRICATE_ARGS := float32_mul float64_mul
mips32-float_mul_d_EXTRICATE_ARGS := float32_mul float64_mul
mips32-float_mul_ps_EXTRICATE_ARGS := float32_mul float64_mul
mips32-float_div_s_EXTRICATE_ARGS := float32_div float64_div
mips32-float_div_d_EXTRICATE_ARGS := float32_div float64_div
mips32-float_div_ps_EXTRICATE_ARGS := float32_div float64_div
mips32-float_recip2_s_EXTRICATE_ARGS := float32_sub float32_mul
mips32-float_recip2_d_EXTRICATE_ARGS := float64_sub float64_mul
mips32-float_recip2_ps_EXTRICATE_ARGS := float32_sub float32_mul
mips32-float_rsqrt2_s_EXTRICATE_ARGS := float32_div float32_sub float32_mul
mips32-float_rsqrt2_d_EXTRICATE_ARGS := float64_div float64_sub float64_mul
mips32-float_rsqrt2_ps_EXTRICATE_ARGS := float32_div float32_sub float32_mul
mips32-float_madd_s_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_madd_d_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_madd_ps_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_msub_s_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-float_msub_d_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-float_msub_ps_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-float_nmadd_s_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_nmadd_d_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_nmadd_ps_EXTRICATE_ARGS := float32_mul float32_add float64_add float64_mul
mips32-float_nmsub_s_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-float_nmsub_d_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-float_nmsub_ps_EXTRICATE_ARGS := float32_sub float32_mul float64_sub float64_mul
mips32-cmp_d_f_EXTRICATE_ARGS := float64_unordered_quiet
mips32-cmpabs_d_f_EXTRICATE_ARGS := float64_unordered_quiet
mips32-cmp_s_f_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmpabs_s_f_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmp_ps_f_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmpabs_ps_f_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmp_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mips32-cmpabs_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mips32-cmp_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmpabs_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmp_ps_un_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmpabs_ps_un_EXTRICATE_ARGS := float32_unordered_quiet
mips32-cmp_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mips32-cmpabs_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mips32-cmp_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mips32-cmpabs_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mips32-cmp_ps_eq_EXTRICATE_ARGS := float32_eq_quiet
mips32-cmpabs_ps_eq_EXTRICATE_ARGS := float32_eq_quiet
mips32-cmp_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mips32-cmpabs_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mips32-cmp_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mips32-cmpabs_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mips32-cmp_ps_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mips32-cmpabs_ps_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mips32-cmp_d_olt_EXTRICATE_ARGS := float64_lt_quiet
mips32-cmpabs_d_olt_EXTRICATE_ARGS := float64_lt_quiet
mips32-cmp_s_olt_EXTRICATE_ARGS := float32_lt_quiet
mips32-cmpabs_s_olt_EXTRICATE_ARGS := float32_lt_quiet
mips32-cmp_ps_olt_EXTRICATE_ARGS := float32_lt_quiet
mips32-cmpabs_ps_olt_EXTRICATE_ARGS := float32_lt_quiet
mips32-cmp_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mips32-cmpabs_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mips32-cmp_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-cmpabs_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-cmp_ps_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-cmpabs_ps_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-cmp_d_ole_EXTRICATE_ARGS := float64_le_quiet
mips32-cmpabs_d_ole_EXTRICATE_ARGS := float64_le_quiet
mips32-cmp_s_ole_EXTRICATE_ARGS := float32_le_quiet
mips32-cmpabs_s_ole_EXTRICATE_ARGS := float32_le_quiet
mips32-cmp_ps_ole_EXTRICATE_ARGS := float32_le_quiet
mips32-cmpabs_ps_ole_EXTRICATE_ARGS := float32_le_quiet
mips32-cmp_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mips32-cmpabs_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mips32-cmp_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mips32-cmpabs_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mips32-cmp_ps_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mips32-cmpabs_ps_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mips32-cmp_d_sf_EXTRICATE_ARGS := float64_unordered
mips32-cmpabs_d_sf_EXTRICATE_ARGS := float64_unordered
mips32-cmp_s_sf_EXTRICATE_ARGS := float32_unordered
mips32-cmpabs_s_sf_EXTRICATE_ARGS := float32_unordered
mips32-cmp_ps_sf_EXTRICATE_ARGS := float32_unordered
mips32-cmpabs_ps_sf_EXTRICATE_ARGS := float32_unordered
mips32-cmp_d_ngle_EXTRICATE_ARGS := float64_unordered
mips32-cmpabs_d_ngle_EXTRICATE_ARGS := float64_unordered
mips32-cmp_s_ngle_EXTRICATE_ARGS := float32_unordered
mips32-cmpabs_s_ngle_EXTRICATE_ARGS := float32_unordered
mips32-cmp_ps_ngle_EXTRICATE_ARGS := float32_unordered
mips32-cmpabs_ps_ngle_EXTRICATE_ARGS := float32_unordered
mips32-cmp_d_seq_EXTRICATE_ARGS := float64_eq
mips32-cmpabs_d_seq_EXTRICATE_ARGS := float64_eq
mips32-cmp_s_seq_EXTRICATE_ARGS := float32_eq
mips32-cmpabs_s_seq_EXTRICATE_ARGS := float32_eq
mips32-cmp_ps_seq_EXTRICATE_ARGS := float32_eq
mips32-cmpabs_ps_seq_EXTRICATE_ARGS := float32_eq
mips32-cmp_d_ngl_EXTRICATE_ARGS := float64_eq float64_unordered
mips32-cmpabs_d_ngl_EXTRICATE_ARGS := float64_eq float64_unordered
mips32-cmp_s_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mips32-cmpabs_s_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mips32-cmp_ps_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mips32-cmpabs_ps_ngl_EXTRICATE_ARGS := float32_eq float32_unordered
mips32-cmp_d_lt_EXTRICATE_ARGS := float64_lt
mips32-cmpabs_d_lt_EXTRICATE_ARGS := float64_lt
mips32-cmp_s_lt_EXTRICATE_ARGS := float32_lt
mips32-cmpabs_s_lt_EXTRICATE_ARGS := float32_lt
mips32-cmp_ps_lt_EXTRICATE_ARGS := float32_lt
mips32-cmpabs_ps_lt_EXTRICATE_ARGS := float32_lt
mips32-cmp_d_nge_EXTRICATE_ARGS := float64_lt float64_unordered
mips32-cmpabs_d_nge_EXTRICATE_ARGS := float64_lt float64_unordered
mips32-cmp_s_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-cmpabs_s_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-cmp_ps_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-cmpabs_ps_nge_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-cmp_d_le_EXTRICATE_ARGS := float64_le
mips32-cmpabs_d_le_EXTRICATE_ARGS := float64_le
mips32-cmp_s_le_EXTRICATE_ARGS := float32_le
mips32-cmpabs_s_le_EXTRICATE_ARGS := float32_le
mips32-cmp_ps_le_EXTRICATE_ARGS := float32_le
mips32-cmpabs_ps_le_EXTRICATE_ARGS := float32_le
mips32-cmp_d_ngt_EXTRICATE_ARGS := float64_le float64_unordered
mips32-cmpabs_d_ngt_EXTRICATE_ARGS := float64_le float64_unordered
mips32-cmp_s_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mips32-cmpabs_s_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mips32-cmp_ps_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mips32-cmpabs_ps_ngt_EXTRICATE_ARGS := float32_le float32_unordered
mips32-r6_cmp_d_af_EXTRICATE_ARGS := float64_unordered_quiet
mips32-r6_cmp_s_af_EXTRICATE_ARGS := float32_unordered_quiet
mips32-r6_cmp_d_un_EXTRICATE_ARGS := float64_unordered_quiet
mips32-r6_cmp_s_un_EXTRICATE_ARGS := float32_unordered_quiet
mips32-r6_cmp_d_eq_EXTRICATE_ARGS := float64_eq_quiet
mips32-r6_cmp_s_eq_EXTRICATE_ARGS := float32_eq_quiet
mips32-r6_cmp_d_ueq_EXTRICATE_ARGS := float64_eq_quiet float64_unordered_quiet
mips32-r6_cmp_s_ueq_EXTRICATE_ARGS := float32_eq_quiet float32_unordered_quiet
mips32-r6_cmp_d_lt_EXTRICATE_ARGS := float64_lt_quiet
mips32-r6_cmp_s_lt_EXTRICATE_ARGS := float32_lt_quiet
mips32-r6_cmp_d_ult_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mips32-r6_cmp_s_ult_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-r6_cmp_d_le_EXTRICATE_ARGS := float64_le_quiet
mips32-r6_cmp_s_le_EXTRICATE_ARGS := float32_le_quiet
mips32-r6_cmp_d_ule_EXTRICATE_ARGS := float64_le_quiet float64_unordered_quiet
mips32-r6_cmp_s_ule_EXTRICATE_ARGS := float32_le_quiet float32_unordered_quiet
mips32-r6_cmp_d_saf_EXTRICATE_ARGS := float64_unordered
mips32-r6_cmp_s_saf_EXTRICATE_ARGS := float32_unordered
mips32-r6_cmp_d_sun_EXTRICATE_ARGS := float64_unordered
mips32-r6_cmp_s_sun_EXTRICATE_ARGS := float32_unordered
mips32-r6_cmp_d_seq_EXTRICATE_ARGS := float64_eq
mips32-r6_cmp_s_seq_EXTRICATE_ARGS := float32_eq
mips32-r6_cmp_d_sueq_EXTRICATE_ARGS := float64_eq float64_unordered
mips32-r6_cmp_s_sueq_EXTRICATE_ARGS := float32_eq float32_unordered
mips32-r6_cmp_d_slt_EXTRICATE_ARGS := float64_lt
mips32-r6_cmp_s_slt_EXTRICATE_ARGS := float32_lt
mips32-r6_cmp_d_sult_EXTRICATE_ARGS := float64_lt float64_unordered
mips32-r6_cmp_s_sult_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-r6_cmp_d_sle_EXTRICATE_ARGS := float64_le
mips32-r6_cmp_s_sle_EXTRICATE_ARGS := float32_le
mips32-r6_cmp_d_sule_EXTRICATE_ARGS := float64_le float64_unordered
mips32-r6_cmp_s_sule_EXTRICATE_ARGS := float32_le float32_unordered
mips32-r6_cmp_d_or_EXTRICATE_ARGS := float64_le_quiet
mips32-r6_cmp_s_or_EXTRICATE_ARGS := float32_le_quiet
mips32-r6_cmp_d_une_EXTRICATE_ARGS := float64_lt_quiet float64_unordered_quiet
mips32-r6_cmp_s_une_EXTRICATE_ARGS := float32_lt_quiet float32_unordered_quiet
mips32-r6_cmp_d_ne_EXTRICATE_ARGS := float64_lt_quiet
mips32-r6_cmp_s_ne_EXTRICATE_ARGS := float32_lt_quiet
mips32-r6_cmp_d_sor_EXTRICATE_ARGS := float64_le
mips32-r6_cmp_s_sor_EXTRICATE_ARGS := float32_le
mips32-r6_cmp_d_sune_EXTRICATE_ARGS := float64_lt float64_unordered
mips32-r6_cmp_s_sune_EXTRICATE_ARGS := float32_lt float32_unordered
mips32-r6_cmp_d_sne_EXTRICATE_ARGS := float64_lt
mips32-r6_cmp_s_sne_EXTRICATE_ARGS := float32_lt
mips32-msa_ctcmsa_EXTRICATE_ARGS := ieee_rm
mips32-msa_fcaf_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_default_nan float32_default_nan float32_eq_quiet
mips32-msa_fcun_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mips32-msa_fceq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_default_nan float32_default_nan float32_eq_quiet
mips32-msa_fcueq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_eq_quiet float64_unordered_quiet float32_eq_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mips32-msa_fclt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_default_nan float32_default_nan float32_lt_quiet
mips32-msa_fcult_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_unordered_quiet float64_default_nan float32_lt_quiet float32_default_nan float32_unordered_quiet
mips32-msa_fcle_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_le_quiet float32_le_quiet
mips32-msa_fcule_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered_quiet float64_le_quiet float32_le_quiet float64_default_nan float32_default_nan float32_unordered_quiet
mips32-msa_fsaf_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float64_eq float32_default_nan float32_eq
mips32-msa_fsun_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered float64_default_nan float32_default_nan float32_unordered
mips32-msa_fseq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float64_eq float32_default_nan float32_eq
mips32-msa_fsueq_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_unordered float32_eq float64_eq float64_default_nan float32_default_nan float32_unordered
mips32-msa_fslt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_default_nan float32_default_nan float32_lt
mips32-msa_fsult_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_unordered float32_lt float64_default_nan float32_default_nan float32_unordered
mips32-msa_fsle_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_default_nan float32_default_nan float32_le
mips32-msa_fsule_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_unordered float32_le float64_default_nan float32_default_nan float32_unordered
mips32-msa_fadd_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_add float32_add
mips32-msa_fsub_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_sub float64_default_nan float32_default_nan float32_sub
mips32-msa_fmul_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_mul float64_default_nan float32_default_nan float32_mul
mips32-msa_fdiv_df_EXTRICATE_ARGS := float64_div float64_default_nan float32_default_nan ieee_ex_to_mips float32_div
mips32-msa_fmadd_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_muladd float64_default_nan float32_default_nan float32_muladd
mips32-msa_fmsub_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_muladd float64_default_nan float32_default_nan float32_muladd
mips32-msa_fexp2_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_scalbn float64_default_nan float32_default_nan float32_scalbn
mips32-msa_fexdo_df_EXTRICATE_ARGS := float64_to_float32 float32_to_float16 float32_default_nan ieee_ex_to_mips float16_default_nan
mips32-msa_ftq_df_EXTRICATE_ARGS := float64_to_int64 float64_scalbn float32_to_int32 float32_scalbn float_raise float32_default_nan ieee_ex_to_mips float16_default_nan
mips32-msa_fmin_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_min float64_is_quiet_nan float64_default_nan float32_default_nan float32_min float32_is_quiet_nan
mips32-msa_fmin_a_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_max float64_min float64_is_quiet_nan float32_max float64_default_nan float32_default_nan float32_min float32_is_quiet_nan
mips32-msa_fmax_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_max float64_is_quiet_nan float64_default_nan float32_default_nan float32_max float32_is_quiet_nan
mips32-msa_fmax_a_df_EXTRICATE_ARGS := float64_min ieee_ex_to_mips float64_max float64_is_quiet_nan float64_default_nan float32_default_nan float32_max float32_min float32_is_quiet_nan
mips32-msa_fcor_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_le_quiet float32_le_quiet
mips32-msa_fcune_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_unordered_quiet float64_default_nan float32_lt_quiet float32_default_nan float32_unordered_quiet
mips32-msa_fcne_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt_quiet float64_default_nan float32_default_nan float32_lt_quiet
mips32-msa_fsor_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_le float64_default_nan float32_default_nan float32_le
mips32-msa_fsune_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_unordered float32_lt float64_default_nan float32_default_nan float32_unordered
mips32-msa_fsne_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_lt float64_default_nan float32_default_nan float32_lt
mips32-msa_fclass_df_EXTRICATE_ARGS := float_class_d float_class_s
mips32-msa_ftrunc_s_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_int64_round_to_zero float64_default_nan float32_default_nan float32_to_int32_round_to_zero
mips32-msa_ftrunc_u_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_to_uint64_round_to_zero float32_to_uint32_round_to_zero
mips32-msa_fsqrt_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_default_nan float32_default_nan float64_sqrt float32_sqrt
mips32-msa_frsqrt_df_EXTRICATE_ARGS := float64_is_quiet_nan float64_div float64_default_nan float32_default_nan float32_is_quiet_nan float64_sqrt float32_sqrt ieee_ex_to_mips float32_div
mips32-msa_frcp_df_EXTRICATE_ARGS := float64_is_quiet_nan float64_div float64_default_nan float32_default_nan float32_is_quiet_nan ieee_ex_to_mips float32_div
mips32-msa_frint_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_round_to_int float64_default_nan float32_default_nan float32_round_to_int
mips32-msa_flog2_df_EXTRICATE_ARGS := ieee_rm ieee_ex_to_mips float64_round_to_int float64_default_nan float32_default_nan float32_round_to_int float64_log2 float32_log2
mips32-msa_fexupl_df_EXTRICATE_ARGS := float32_to_float64 ieee_ex_to_mips float16_to_float32 float64_default_nan float32_default_nan
mips32-msa_fexupr_df_EXTRICATE_ARGS := float32_to_float64 ieee_ex_to_mips float16_to_float32 float64_default_nan float32_default_nan
mips32-msa_ffql_df_EXTRICATE_ARGS := float64_scalbn int32_to_float64 ieee_ex_to_mips float32_scalbn int32_to_float32 float64_default_nan float32_default_nan
mips32-msa_ffqr_df_EXTRICATE_ARGS := float64_scalbn int32_to_float64 ieee_ex_to_mips float32_scalbn int32_to_float32 float64_default_nan float32_default_nan
mips32-msa_ftint_s_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_int64 float64_default_nan float32_default_nan float32_to_int32
mips32-msa_ftint_u_df_EXTRICATE_ARGS := ieee_ex_to_mips float64_to_uint64 float64_default_nan float32_default_nan float32_to_uint32
mips32-msa_ffint_s_df_EXTRICATE_ARGS := ieee_ex_to_mips int64_to_float64 float64_default_nan float32_default_nan int32_to_float32
mips32-msa_ffint_u_df_EXTRICATE_ARGS := ieee_ex_to_mips uint64_to_float64 float64_default_nan float32_default_nan uint32_to_float32
mips32-mulsh_i64_EXTRICATE_ARGS := muls64
mips32-muluh_i64_EXTRICATE_ARGS := mulu64

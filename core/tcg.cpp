...
#error
  ...
  auto print_pinned_env_globals = [&](void) -> void {
    ...
    const std::array<const char *, 66> pinned_env_glbs{
      "f0",
      "f1",
      "f2",
      "f3",
...
#else
    const std::array<const char *, 87> pinned_env_glbs{
      "f0_0",
      "f0_1",
      "f1_0",
      "f1_1",
...
#undef __TCG_CONST
...
#if defined(TARGET_MIPS32) || defined(TARGET_MIPS64)
  {
    ...
    printf("/* offset of f0 = %u */\n", off);
  }
  {
    unsigned off = offsetof(CPUMIPSState, active_fpu.fpr[1].d) -
                   offsetof(CPUMIPSState, active_tc.gpr[29]);
    printf("/* offset of f1 = %u */\n", off);
  }
  {
    unsigned off = offsetof(CPUMIPSState, active_fpu.fpr[2].d) -
                   offsetof(CPUMIPSState, active_tc.gpr[29]);
    printf("/* offset of f2 = %u */\n", off);
  }
  {
    unsigned off = offsetof(CPUMIPSState, active_fpu.fpr[3].d) -
                   offsetof(CPUMIPSState, active_tc.gpr[29]);
    printf("/* offset of f3 = %u */\n", off);
  }
  {
    unsigned off = offsetof(CPUMIPSState, active_fpu.fpr[12].d) -
                   offsetof(CPUMIPSState, active_tc.gpr[29]);
    printf("/* offset of f12 = %u */\n", off);
  }
  {
    unsigned off = offsetof(CPUMIPSState, active_fpu.fpr[13].d) -
                   offsetof(CPUMIPSState, active_tc.gpr[29]);
    printf("/* offset of f13 = %u */\n", off);
  }
  {

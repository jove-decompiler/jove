...
typedef void (*libmc2llvm_emulate_dynamic_linker_ty)(void);
...
int main(int argc, char **argv) {
  ...
  libmc2llvm_emulate_dynamic_linker_ty libmc2llvm_emulate_dynamic_linker =
      (libmc2llvm_emulate_dynamic_linker_ty)dlsym(handle, "libmc2llvm_emulate_dynamic_linker");
  assert(libmc2llvm_emulate_dynamic_linker);

  libmc2llvm_init(argv[2]);
  libmc2llvm_emulate_dynamic_linker();

...
_NAKED uint64_t _jove_thunk0(uint64_t dstpc,
                             uint64_t *emuspp);

_NAKED uint64_t _jove_thunk1(uint64_t x0,
                             uint64_t dstpc,
                             uint64_t *emuspp);

_NAKED uint64_t _jove_thunk2(uint64_t x0,
                             uint64_t x1,
                             uint64_t dstpc,
                             uint64_t *emuspp);

_NAKED uint64_t _jove_thunk3(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t dstpc,
                             uint64_t *emuspp);

_NAKED uint64_t _jove_thunk4(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t x3,
                             uint64_t dstpc,
...
_NAKED uint64_t _jove_thunk5(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t x3,
                             uint64_t x4,
...
_NAKED uint64_t _jove_thunk6(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t x3,
                             uint64_t x4,
...
_NAKED uint64_t _jove_thunk7(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t x3,
                             uint64_t x4,
...
_NAKED uint64_t _jove_thunk8(uint64_t x0,
                             uint64_t x1,
                             uint64_t x2,
                             uint64_t x3,
                             uint64_t x4,
...
uint64_t _jove_thunk0(uint64_t dstpc   /* x0 */,
                      uint64_t *emuspp /* x1 */) {
...
uint64_t _jove_thunk1(uint64_t x0,
                      uint64_t dstpc   /* x1 */,
                      uint64_t *emuspp /* x2 */) {
  asm volatile(JOVE_THUNK_PROLOGUE
...
uint64_t _jove_thunk2(uint64_t x0,
                      uint64_t x1,
                      uint64_t dstpc   /* x2 */,
                      uint64_t *emuspp /* x3 */) {
  asm volatile(JOVE_THUNK_PROLOGUE
...
uint64_t _jove_thunk3(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t dstpc   /* x3 */,
                      uint64_t *emuspp /* x4 */) {
...
uint64_t _jove_thunk4(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t x3,
                      uint64_t dstpc   /* x4 */,
...
uint64_t _jove_thunk5(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t x3,
                      uint64_t x4,
...
uint64_t _jove_thunk6(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t x3,
                      uint64_t x4,
...
uint64_t _jove_thunk7(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t x3,
                      uint64_t x4,
...
uint64_t _jove_thunk8(uint64_t x0,
                      uint64_t x1,
                      uint64_t x2,
                      uint64_t x3,
                      uint64_t x4,

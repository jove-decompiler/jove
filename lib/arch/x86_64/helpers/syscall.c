...
#define ___SYSCALL0(nr, nm)                                                    \
  static _NOINL unsigned long _jove_sys_##nm(void) {                           \
    unsigned long _ret;                                                        \
                                                                               \
...
#define ___SYSCALL1(nr, nm, t1, a1)                                            \
  static _NOINL unsigned long _jove_sys_##nm(t1 a1) {                          \
    unsigned long _ret;                                                        \
                                                                               \
    register unsigned long _nr asm("rax") = nr;                                \
                                                                               \
...
#define ___SYSCALL2(nr, nm, t1, a1, t2, a2)                                    \
  static _NOINL unsigned long _jove_sys_##nm(t1 a1, t2 a2) {                   \
    unsigned long _ret;                                                        \
                                                                               \
    register unsigned long _nr asm("rax") = nr;                                \
                                                                               \
...
#define ___SYSCALL3(nr, nm, t1, a1, t2, a2, t3, a3)                            \
  static _NOINL unsigned long _jove_sys_##nm(t1 a1, t2 a2, t3 a3) {            \
    unsigned long _ret;                                                        \
                                                                               \
    register unsigned long _nr asm("rax") = nr;                                \
                                                                               \
...
#define ___SYSCALL4(nr, nm, t1, a1, t2, a2, t3, a3, t4, a4)                    \
  static _NOINL unsigned long _jove_sys_##nm(t1 a1, t2 a2, t3 a3, t4 a4) {     \
    unsigned long _ret;                                                        \
                                                                               \
    register unsigned long _nr asm("rax") = nr;                                \
                                                                               \
